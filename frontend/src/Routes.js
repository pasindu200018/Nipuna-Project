  ...
  return (
    <Router>
      <Switch>
        ...
        <PrivateRoutes path="/schedule" exact component={ScheduleNotifications} />
        <PrivateRoutes path="/bulk" exact component={BulkNotifications} />
        <PrivateRoutes path="/add-slider" exact component={AddSliderImages} />
        <PrivateRoutes path="/mobile-settings" exact component={MobileSettings} />
        <PrivateRoutes path="/packages" exact component={Packages} />
        <PrivateRoutes path="/products" exact component={Shop} />
        <PrivateRoutes path="/product-categories" exact component={ProductCategory} />
        <PrivateRoutes path="/add-new-product-category" exact component={AddProductCategory} />
        <PrivateRoutes path="/add-new-product" exact component={AddNewProduct} />
        ...
        <PrivateRoutes path="/general-settings" exact component={GeneralSettings} />
