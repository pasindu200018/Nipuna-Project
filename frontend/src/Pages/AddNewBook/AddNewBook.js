...
const AddNewBook = () => {
  ...
  const [chapters, setChapters] = useState([
    { chapter_number_epub: [], chapter_name_epub: [], BookEPUB: [] },
  ]);
  const [chaptersTxt, setChaptersTxt] = useState([
    { chapter_number_txt: [], chapter_name_txt: [], BookTEXT: [] },
  ]);
  const [chaptersAudio, setChaptersAudio] = useState([
    { AudioBookMale: [], AudioBookFemale: [], AudioBookDramatic: [] },
  ]);
  ...
  const handleFormChange = (index, field, value) => {
    ...
    if (field === "subCategories") {
      data[index].subCategories = value;
    } else {
  ...
  const removeSubCategory = (index, subCategoryIndex) => {
    let data = [...inputFields];
    data[index].subCategories.splice(subCategoryIndex, 1);
    setInputFields(data);
  };

  const addFields = (event) => {
    event.preventDefault();
    let newField = { category: "", subCategories: [] };
  ...
  const onCategoryChange = (value, index) => {
    handleFormChange(index, "category", value);
  };
                ...
                >
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Printed In Year Is Required",
                      },
                    ]}
                    requiredMark={"optional"}
                  ...
                  {/* add catgories and sub categories */}
                            ...
                            (subCategory, subCategoryIndex) => (
                              <div key={subCategoryIndex}>
                                <Select
                                  ...
                                  onChange={(value) => {
                                    ...
                                    newSubCategories[subCategoryIndex] = value;
                                    handleFormChange(
                                      index,
                                      "subCategories",
                                      newSubCategories
                              ...
                              <Option value={data.material} key={data.name}>
                                ...
                                <button
                                  type="button"
                                  onClick={() =>
                                    removeSubCategory(index, subCategoryIndex)
                                  }
                                >
                                  Remove Sub Category
                                </button>
                  ...
                  <button onClick={addFields}>Add More Category..</button>
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Previous Series Is Required",
                      },
                    ]}
                    requiredMark={"optional"}
                  ...
                  <Form.Item name="images3" label="Add Front Cover">
                    <div>
                      <ImgCrop
                        aspect={1 / 1.48}
                        onModalOk={async (obj) => {
                          try {
                            ...
                            if (obj.status !== "removed") {
                              ...
                              if (response && response.awsUrl) {
                                ...
                                console.error(
                                  "Invalid response from UploadImage:",
                                  response
                                );
                            ...
                            console.error(
                              "Error while uploading front cover:",
                              error
                            );
                ...
                >
                          ...
                          <Upload
                            ...
                            onChange={async (obj) => {
                              ...
                              if (obj.file.status !== "removed") {
                                ...
                                const url =
                                  CategorySelect && DateSelect && AuthorSelect
                                    ? await dispatch(UploadFile(payload))
                                    : notification.error({
                                        message: "Form Fill",
                                        description:
                                ...
                                setChapters((prevChapters) => {
                                  ...
                                  if (updatedChapters.length > 0) {
                                    updatedChapters[0].BookEPUB[index] = url
                                      ? [{ url: url.awsUrl }]
                                      : [];
                  ...
                  {chaptersTxt.map((chapter, index) => (
                    <div key={index}>
                            ...
                            onChange={async (obj) => {
                              ...
                              if (obj.file.status !== "removed") {
                                ...
                                setChaptersTxt((prevChapters) => {
                                  ...
                                  //updatedChapters[index].BookEPUB = url ? [{ url: url.awsUrl }] : [];
                                  if (updatedChapters.length > 0) {
                                    updatedChapters[0].BookTEXT[index] = url
                                      ? [{ url: url.awsUrl }]
                                      : [];
                                    //updatedChapters.BookEPUB[index] = url ? [{ url: url.awsUrl }] : [];
                                  }
                      ...
                      <Button
                        type="link"
                        onClick={() => handleRemoveChapterTxt(index)}
                      >
                        Remove Chapter
                      </Button>
                    </div>
              ...
              <div className="add-new-form white-card">
                ...
                >
                  ...
                  >
                    <DatePicker
                      defaultValue={
                        state && moment(state?.audio_published_year)
                      }
                      style={{ width: "100%" }}
                      picker="year"
                      onChange={(date, dateString) => {
                  ...
                  {chaptersAudio.map((chapter, index) => (
                    <div key={index}>
                      <Form.Item
                        label={`Upload Chapter(Audio-Male) ${index + 1}`}
                      >
                        <div>
                          <Upload
                            listType="picture-card"
                            ...
                            onChange={async (obj) => {
                              ...
                              if (obj.file.status !== "removed") {
                                ...
                                setChaptersAudio((prevChapters) => {
                                  const updatedChapters = [...prevChapters];
                                  if (updatedChapters.length > 0) {
                                    updatedChapters[0].AudioBookMale[index] =
                                      url ? [{ url: url.awsUrl }] : [];
                      ...
                      <Form.Item
                        label={`Upload Chapter(Audio-Female) ${index + 1}`}
                      >
                        <div>
                          <Upload
                            listType="picture-card"
                            fileList={
                              chaptersAudio[index]?.AudioBookFemale || []
                            }
                            onChange={async (obj) => {
                              console.log(obj);
                              if (obj.file.status !== "removed") {
                                ...
                                setChaptersAudio((prevChapters) => {
                                  const updatedChapters = [...prevChapters];
                                  if (updatedChapters.length > 0) {
                                    updatedChapters[0].AudioBookFemale[index] =
                                      url ? [{ url: url.awsUrl }] : [];
                                  }
                                  return updatedChapters;
                                });
                      ...
                      <Form.Item
                        label={`Upload Chapter(Audio-Dramatic) ${index + 1}`}
                      >
                        <div>
                          <Upload
                            listType="picture-card"
                            fileList={
                              chaptersAudio[index]?.AudioBookDramatic || []
                            }
                            onChange={async (obj) => {
                              console.log(obj);
                              if (obj.file.status !== "removed") {
                                ...
                                setChaptersAudio((prevChapters) => {
                                  const updatedChapters = [...prevChapters];
                                  if (updatedChapters.length > 0) {
                                    updatedChapters[0].AudioBookDramatic[
                                      index
                                    ] = url ? [{ url: url.awsUrl }] : [];
                                  }
                                  return updatedChapters;
                            ...
                            customRequest={() => {}}
                          >
                            {chaptersAudio[index]?.AudioBookDramatic?.length >=
                            1
                              ? null
                              : uploadButton}
                          </Upload>
                      ...
                      <Button
                        type="link"
                        onClick={() => handleRemoveChapterAudio(index)}
                      >
                        Remove Chapter
                      </Button>
                    </div>
